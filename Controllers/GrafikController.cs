...
namespace Online_Ticari_Otomasyon.Controllers
{
    public class GrafikController : Controller
    {
        ...
        public ActionResult Index2()
        {
            ...
            grafikciz.AddTitle("Kategori - Ürün Stok Sayısı").AddLegend("Stok").AddSeries("Değerler", xValue: new[] { "Konsol", "Telefon", "Bilgisayar" }, yValues: new[] { 85, 66, 98 }).Write();
        ...
        public List<Sinif2> Urunlistesi2()
        {
            ...
            //{
            //    snf = con.Uruns.Select(x => new Sinif2
            //    {
            //        urn = x.UrunAd,
            //        stk = x.Stok
            //    }).ToList();
